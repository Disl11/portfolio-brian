  ...
  return (
    <section className="max-w-6xl mx-auto px-4 py-16 md:py-24">
      ...
      <div className="grid md:grid-cols-3 gap-6 mb-16">
        {[
          {
            href: "mailto:brian.farnier@example.com",
            icon: (
            ...
            label: "Email",
            value: "brian.farnier@example.com",
          },
          {
          ...
          <a
            ...
            className="group flex items-center gap-4 bg-[#0a1e35] border border-orange-300/20 p-5 rounded-xl hover:border-orange-300/60 hover:bg-[#0f2944] transition-all duration-300"
          >
            <div className="shrink-0 w-12 h-12 bg-orange-300/10 rounded-lg flex items-center justify-center group-hover:bg-orange-300/20 transition">
              {icon}
            </div>
            <div className="min-w-0">
              <p className="text-orange-300 text-sm font-semibold uppercase tracking-wide">
                {label}
              </p>
              <p className="text-foreground/90 text-sm truncate">{value}</p>
            </div>
          </a>
        ))}
      </div>
      ...
      <div className="max-w-2xl mx-auto">
        <div className="bg-[#0a1e35] border border-orange-300/20 rounded-2xl p-8 md:p-10">
          <h2 className="text-2xl font-bold text-orange-300 mb-6">
            Envoyez-moi un message
          </h2>
          <form
            action="mailto:brian.farnier@example.com"
            method="POST"
            encType="text/plain"
            className="space-y-5"
          >
            <div className="grid sm:grid-cols-2 gap-5">
              <div className="space-y-2">
                ...
                <input
                  ...
                  className="w-full bg-[#061423] border border-orange-300/20 rounded-lg px-4 py-3 text-foreground placeholder:text-foreground/40 focus:outline-none focus:border-orange-300/60 transition"
                />
              </div>
              <div className="space-y-2">
            ...
            <div className="space-y-2">
              ...
              <textarea
                ...
                className="w-full bg-[#061423] border border-orange-300/20 rounded-lg px-4 py-3 text-foreground placeholder:text-foreground/40 focus:outline-none focus:border-orange-300/60 transition resize-none"
              />
            </div>
            <button
              type="submit"
              className="w-full bg-orange-300 text-[#061423] font-bold py-3 rounded-lg hover:bg-white transition"
            >
              Envoyer le message
            </button>
          </form>
